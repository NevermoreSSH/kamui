...
sleep 2
echo ".: KAMUI Project V1 :." > /etc/issue.net
...
echo ".: KAMUI Project V1 :." > /etc/db-issue.net
mkdir /etc/dropbear
...
sleep 2
apt install -y python python3 python3-setuptools
...
wget -O /kamui/menu/ssh/limit.sh "${repoDir}files/menu/ssh/limit.sh"
wget -O /kamui/menu/ssh/change_limit.sh "${repoDir}files/menu/ssh/change_limit.sh"
